...
class SiteController extends Controller
{
     ...
     * @return mixed
     */
    public function actionEditme()
    {
        $model = User::findOne(['id' => Yii::$app->user->id]);
        $model->scenario = 'editme';
        $old_password = $model->password_hash;

        $model->password_hash = '';
        if ($this->request->isPost && $model->load($this->request->post()) ) {
            if($model->password_hash != ''){ // ถ้ามีการเปลี่ยนรหัสผ่าน
                $model->setPassword($model->password_hash);
            }else{ // ถ้าไม่มีการเปลี่ยนรหัสผ่าน
        ...
        return $this->render('editme' , ['model' => $model]);
    }
     ...
     * @return mixed
     */
    public function actionDetail($book_isbn){
        $books = BsBook::find()->all();
        return $this->render('detail' , [
            'model' => BsBook::findOne(['book_isbn' => $book_isbn]),
            'books' => $books,
        ]);
    }
    ...
    {
        $categories = BsCategory::find()->all();
