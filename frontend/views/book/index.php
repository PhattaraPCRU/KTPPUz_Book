    ...
    <div class="row">
        <div class="col-md-12">
            <?php $dynagrid = DynaGrid::begin([
                'options'=>[
                    'id'=>'book',// a unique identifier is important
                    'class'=>['table-sm'],
                ],
                'theme'=>'panel-info',
            ...
            //'cate_id',
                    [
                        ...
                        //     return !empty($model->book_date) ? Yii::$app->formatter->asDateTime(strtotime($model->book_date)) : null;
                        // },
                        ...
                        'buttons'=>[
                            ...
                            'view'=>function($url,$model,$key){
                                return Html::a('<i class="fas fa-eye"></i>',
                                    Url::to(['view', 'book_isbn' => $model->book_isbn]),// $url, $model, $key
                                    [
                                        'class'=>'btn btn-info',
                                        'title'=>'Detail',
                                        'data-toggle' => "tooltip",
                            ...
                            'update'=>function($url,$model,$key){
                                return Html::a('<i class="fas fa-pencil-alt"></i>',
                                    Url::to(['update', 'book_isbn' => $model->book_isbn]),// $url, $model, $key
                                    [
                            ...
                            'delete'=>function($url,$model,$key){
                                return Html::a('<i class="fas fa-trash-alt"></i>',
                                    Url::to(['delete', 'book_isbn' => $model->book_isbn]),// $url, $model, $key
                                    [
