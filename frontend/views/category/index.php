    ...
    <div class="row">
        <div class="col-md-12">
            <?php $dynagrid = DynaGrid::begin([
                'options'=>[
                    'id'=>'category',// a unique identifier is important
                    'class'=>['table-sm'],
                ],
                'theme'=>'panel-info',
                        ...
                        'buttons'=>[
                            ...
                            'view'=>function($url,$model,$key){
                                return Html::a('<i class="fas fa-eye"></i>',
                                    Url::to(['view', 'cate_id' => $model->cate_id]),// $url, $model, $key
                                    [
                                        'class'=>'btn btn-info',
                                        'title'=>'Detail',
                                        'data-toggle' => "tooltip",
                            ...
                            'update'=>function($url,$model,$key){
                                return Html::a('<i class="fas fa-pencil-alt"></i>',
                                    Url::to(['update', 'cate_id' => $model->cate_id]),// $url, $model, $key
                                    [
                            ...
                            'delete'=>function($url,$model,$key){
                                return Html::a('<i class="fas fa-trash-alt"></i>',
                                    Url::to(['delete', 'cate_id' => $model->cate_id]),// $url, $model, $key
                                    [
